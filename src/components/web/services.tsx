...
export function Services() {
  ...
  return (
    <div className="w-full bg-white my-16 sm:my-20 lg:my-[180px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-[#424242] text-base font-normal leading-[150%] mb-4">
              Grants.com.au equips Australian businesses with powerful tools,
              data-driven insights, and expert resources to discover, manage,
              and secure government funding. Our platform streamlines the entire
              grant journey—from identifying eligible grants that align with
              your strategic objectives, to organizing applications and
              monitoring progress in one centralized location.
            </p>
            <p className="text-[#424242] text-base font-normal leading-[150%] mb-8">
              With intuitive search capabilities, personalized recommendations,
              and intelligent management tools, we enable you to stay ahead of
              deadlines and concentrate on your core priority—business growth.
              Whether you are a startup pursuing early-stage capital or an
              established enterprise seeking expansion funding, our platform
              delivers efficiency, transparency, and simplicity. Find
            ...
            {services.map((service) => {
              ...
              return (
                ...
                >
                  ...
                  <CardContent>
                    <p className="text-[#0C2661] text-xl font-bold mb-2">
                      {service.title}
                    </p>
