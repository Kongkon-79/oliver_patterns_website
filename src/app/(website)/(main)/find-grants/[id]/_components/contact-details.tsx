...
const ContactDetails = () => {
  ...
  return (
    <div className="bg-[#E4F1FF] py-5 md:py-7 lg:py-9 px-4 md:px-0">
      <div className="container mx-auto">
        <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#0C2661] leading-[150%] pb-4 md:pb-6 lg:pb-8">
          Need help applying for this grant? Send your contact details below.
        </h3>
        <Form {...form}>
            ...
            <div className="flex items-center gap-5 w-full">
              <div className="lg:w-1/2">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-base md:text-lg font-semibold text-[#0C2661] leading-[150%]">
                        Full Name
                      </FormLabel>
                      <FormControl>
                        <Input
